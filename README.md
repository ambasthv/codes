...
step1 = (df_filtered.groupby('riksunitnames')['obligor_id']
         .count()
         .reset_index()
...
sns.barplot(data=step1, x='riksunitnames', y='Observation_Count')
...
step2 = (df_filtered.groupby(['Year', 'riksunitnames'])['obligor_id']
         .count()
...
step4 = (df_filtered.groupby(['YearMonth', 'riksunitnames'])['obligor_id']
         .count()
         .unstack(fill_value=0)
         .reset_index())
...
step5 = (df_filtered.groupby('riksunitnames')['exposure']
         .sum()
         .reset_index()
...
plt.figure(figsize=(10, 6))
sns.barplot(data=step5, x='riksunitnames', y='Total_Exposure')
...
step6 = (df_filtered.groupby('riksunitnames')['balance']
         .agg(['sum', 'count'])
         .reset_index()
...
plt.figure(figsize=(10, 6))
sns.barplot(data=step6, x='riksunitnames', y='Total_Balance')
...
step8 = (df_filtered.groupby('riksunitnames')['final_default_ind']
         .agg(['count', 'sum'])
         .reset_index())
...
# By RiskUnitName
dr1 = (df_filtered.groupby('riksunitnames')['final_default_ind']
       .agg(['count', 'sum'])
